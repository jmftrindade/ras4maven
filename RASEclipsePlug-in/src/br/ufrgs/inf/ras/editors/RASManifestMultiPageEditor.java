 ...
 * </ul>
 */
public class RASManifestMultiPageEditor extends FormEditor implements IResourceChangeListener{
	 ...
	 */
	public RASManifestMultiPageEditor() {
		super();
    ...
    protected void addPages() {
        try {
            //addPage(new RASAssetFormPage(this, "id", "title"));
            addPage(0, new FreeFormPage(this));
            addPage(1, new SecondPage(this));
            addPage(2, new ThirdPage(this));
            addPage(3, new MasterDetailsPage(this));
            addPage(4, new PageWithSubPages(this));
